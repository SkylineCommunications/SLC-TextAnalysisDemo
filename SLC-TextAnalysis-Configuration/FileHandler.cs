...
public class FileHandler
{
    ...
    public static string FILE_FOLDER { get; set; } = @"C:\Skyline DataMiner\AI-sample\secrets\";
	...
	public static bool CheckIsSecretsFile(string path)
	{
		string fileNameWithExtension = Path.GetFileName(path);

		return (fileNameWithExtension == "secrets.json");
	}
